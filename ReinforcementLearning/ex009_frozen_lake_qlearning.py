...
class QLearningAgent:
    ...
    def update_q_value(self, state, action, reward, next_state, done):
        ...
        if done:
            ...
            # Q-learning: use maximum Q-value of next state (off-policy)
    ...
    def train_episode(self):
        ...
        while steps < max_steps:
            ...
            # Update Q-value (Q-learning: no need to select next action)
    ...
    def plot_results(self):
        ...
        plt.tight_layout()
        plt.savefig('/home/jso1/local/teaching/RL/qlearning_frozen_lake_results.png', dpi=300, bbox_inches='tight')
        plt.show()
...
def main():
    ...
    # Create Q-learning agent with optimized parameters for slippery environment
